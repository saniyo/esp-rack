...
// rest.update, per-tab restPath, per-action restPath, and the generic
// endpoints[] list (role-keyed paths, used by filesystem / OTA / etc).
// Walked once per check; manifests are small (≤30 features in practice)
// so a flat scan beats maintaining a parallel index.
