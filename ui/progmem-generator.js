    ...
    compiler.hooks.emit.tapAsync(
      ...
      (compilation, callback) => {
        ...
        try {
          ...
          // Files we never want baked into PROGMEM_WWW. Source maps
          // are dev-time aids — embedding them in firmware costs ~6 MB
          // of flash per CRA build for zero runtime benefit.
          const isExcluded = (relativePath) =>
            relativePath.endsWith('.map') ||
            relativePath.endsWith('.LICENSE.txt');
          ...
          const writeFiles = () => {
            ...
            Object.keys(assets).forEach((relativeFilePath) => {
              if (isExcluded(relativeFilePath)) return;
