...
#ifdef ESP32
// Arduino-ESP32 3.x split esp_read_mac / ESP_MAC_WIFI_STA out of the
// auto-pulled headers; pull them in directly so the code compiles on
// both the legacy 2.x core (S3) and the new IDF 5 core (C6).
#include <esp_mac.h>
#endif
